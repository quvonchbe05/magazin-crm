@extends('layouts.app')
@section('title',"Xisobotning to'liq ro\'yxati")
    ...
    <div class="col-lg-6 text-center p-5 col-md-6 col-sm-12">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                <a href="{{ route('statistic.index') }}" class="btn btn-primary">Orqaga</a>
            </div>
        </div>
    </div>
    @endcan
...
<script>
    ...
    $('#date').change(function () {
        ...
        $.ajax({
            type:'POST',
            url:"{{ route('statistic.filterByDateMore') }}",
            data:{
                date:$('#date').val(),
        ...
        $.ajax({
            type:'POST',
            url:"{{ route('statistic.filterByMonthMore') }}",
            data:{
                month:$('#month').val(),
                worker_id:$('#worker').val(),
            },
