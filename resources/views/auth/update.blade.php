...
@section('content__title',"Xodimni taxrirlash")
@section('content')
@if ($errors->any())
...
<form action="{{ route('register.update',$worker->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            ...
            <input type="text" class="form-control" value="{{ $worker->fish }}" id="fish" name="fish" required>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            ...
            <select class="form-control" id="role" name="role" required>
                ...
                <option value="{{ $role->id }}" @selected($role->id == $worker->role_id)>
                    {{ $role->role_name }}
                </option>
                @endforeach
            </select>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            ...
            <input type="number" class="form-control" value="{{ $worker->phone1 }}" id="phone1" name="phone1" required>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            <label for="phone2">Telefon 2 (Ixtiyoriy)</label>
            <input type="number" class="form-control" value="{{ $worker->phone2 }}" id="phone2" name="phone2">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            <label for="t_sana">Tug'ilgan sana</label>
            <input type="date" class="form-control" value="{{ $worker->t_sana }}" id="t_sana"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            ...
            <input type="email" class="form-control" value="{{ $worker->email }}" id="email"
                name="email" placeholder="Tizimga kirishi uchun email..." required>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            <label for="password">Parol</label>
            <input type="password" class="form-control" placeholder="Tizimga kirishi uchun parol..." value="{{ old('password') }}" id="password" name="password">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 my-4  ">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 my-4">
            ...
            <input type="date" class="form-control" placeholder="Tizimga kirishi uchun parol..." value="{{ $worker->kelgan_sana }}" id="kelgan_sana" name="kelgan_sana" required>
            <div class="d-flex justify-content-end pt-4">
                <a href="{{ route('register.index') }}" class="btn btn-primary my-4 mx-1">Orqaga</a>
                <button type="submit" class="btn btn-primary my-4">Taxrirlsh</button>
            </div>
        </div>
    </div>
</form>
